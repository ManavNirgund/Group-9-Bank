...
import sneha from "../../Assets/Images/login.gif";
// import "./Register.css"
...
const Register = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row" }}>
      {/* <img src={register} alt="Register" width="700rem" style={{alignSelf: "flex-end"}}/> */}
      <img
        src={sneha}
        alt="Register"
        height="500rem"
        style={{ alignSelf: "flex-end", marginLeft: "10rem" }}
      />
      <Container
        maxWidth="sm"
        sx={{
      ...
      >
        ...
        >
          <Typography variant="h4" sx={{ marginTop: "-3rem", color: "white" }} align="center">
            Register
          </Typography>
          <Grid container spacing={2} className="mt-4">
            ...
            <Grid item xs={6}>
              <FormControl fullWidth variant="filled" sx={{backgroundColor: "white", color: "black", borderRadius: "5px"}}>
